  ...
  return <article className="mt-12 border-t border-border pt-8">
    ...
    <dl className="mt-5 grid gap-6 text-sm sm:grid-cols-2">
      ...
      <div>
        ...
        <ol className="mt-2 space-y-1.5">
          <li className="flex gap-2 text-muted-foreground"><span className="font-mono text-xs font-bold text-primary">1.</span><span>Project Supervisor:<br /><span className="font-bold text-foreground">Shouvik Chaudhuri</span><br />Project conception and progress supervision</span></li>
          <li className="flex gap-2 text-muted-foreground"><span className="font-mono text-xs font-bold text-primary">2.</span><span>Video Production:<br /><a href="https://www.linkedin.com/in/oliverjorgensen/" target="_blank" rel="noreferrer" className="font-bold text-foreground hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">Oliver Vedby Jørgensen</a> with <a href="https://www.linkedin.com/in/mat%C3%ADas-ramiro-cusicanqui-bejarano-6a6707385/" target="_blank" rel="noreferrer" className="font-bold text-foreground hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">Matías R. Cusicanqui</a><br />Video conception, scripting, shooting and editing</span></li>
          <li className="flex gap-2 text-muted-foreground"><span className="font-mono text-xs font-bold text-primary">3.</span><span>Project Supporter:<br /><a href="https://www.linkedin.com/in/hossein-ramezani-a07a2672/" target="_blank" rel="noreferrer" className="font-bold text-foreground hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">Hossein Ramezani</a><br />Lab-in-charge (Cyber Physical Lab)</span></li>
        </ol>
      </div>
    </dl>
