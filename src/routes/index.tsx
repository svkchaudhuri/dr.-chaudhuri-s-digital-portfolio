...
const researchLeadership = [
  ...
  { label: "Student mentorship", description: "Co-supervised four Master's dissertations, four In-Company projects and six Bachelor's projects in mechatronics and control.", badge: "14 Projects Supervised", Icon: GraduationCap },
